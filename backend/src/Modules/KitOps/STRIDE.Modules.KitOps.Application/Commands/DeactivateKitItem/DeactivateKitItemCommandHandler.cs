...
internal sealed class DeactivateKitItemCommandHandler
    : IRequestHandler<DeactivateKitItemCommand, Result>
{
    private readonly IKitItemRepository _kitItems;
    private readonly IAuditLogger       _audit;
    private readonly ICurrentUser       _currentUser;

    public DeactivateKitItemCommandHandler(
    ...
    public async Task<Result> Handle(
        DeactivateKitItemCommand request, CancellationToken cancellationToken)
    {
        ...
        try
        {
            item.Deactivate(request.DeactivatedBy);
        }
        ...
        _ = _audit.LogAsync(new AuditLogEntry(
            ...
            Action:       AuditActions.KitItemDeactivated,
