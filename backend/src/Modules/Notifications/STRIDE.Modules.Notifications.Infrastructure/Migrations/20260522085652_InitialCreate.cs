...
namespace STRIDE.Modules.Notifications.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_TenantId_RecipientId_IsDeleted",
                schema: "notifications",
                table: "Notifications",
                columns: new[] { "TenantId", "RecipientId", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_TenantId_RecipientId_IsRead_IsDeleted",
                schema: "notifications",
                table: "Notifications",
